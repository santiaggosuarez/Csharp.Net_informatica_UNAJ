	...
	class Program
	{
		public static void Main(string[] args)
		{
			...
			switch(op){
				...
				case "2": {actualizarDiagnostico(Medico medico1, int dni, string diagnostico);break;}
				case "3": eliminarTurno(Medico medico1, string hora);break;
				case "4": verTurnos(Medico medico1);break;
				case "5": verObras(Medico medico1);break;
				case "6": agregarPaciente(Medico medico1);break;
				case "7": eliminarPaciente(Medico medico1);break;
				case "8": verPacientes(Medico medico1);break;
		...
		public static void actualizarDiagnostico(Medico medico1, int dni, string diagnostico)
		{
		...
		public static void eliminarTurno(Medico medico1, string hora)
		{
			bool existe = false;
